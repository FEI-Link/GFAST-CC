	...
	<div>
		<el-card shadow="hover">
			...
			<el-table :data="tableData.data" style="width: 100%">
				...
				<el-table-column label="干部姓名" align="center" prop="user_nickname" />
				<el-table-column label="干部任职部门" align="center" prop="dept_name" />
				<el-table-column label="入职时间" align="center" prop="created_at" />
...
import { ganbu, exportganbu } from '/@/api/demo/ganbu';
...
const getList = () => {
	ganbu(state.tableData.param).then((res: any) => {
